...
export default function DoublyReinforcedTool() {
  ...
  // Fixes lag/erasing difficulty: Selects all text on tap
  ...
  // Logic for Asc (Cell D21)
  const asc = muMinusMuLimit / (fsc * (d - dPrime));

  // --- AST LOGIC (COLUMN D: TO FIND Ast) ---
  // Pt_max logic from cell D23 lookup: Result should be 499.44 for Mu=65
