...
export default function DoublyReinforcedTool() {
  ...
  // Seamless Mobile Experience: Auto-select text on tap
  ...
  // --- EXACT EXCEL MATHEMATICS (COLUMN D LOGIC) ---
  ...
  // --- AST LOGIC FOR 499.44 RESULT ---
  // This matches your spreadsheet Column D "TO FIND Ast" logic
  const ast1 = (0.36 * inputs.fck * n.b * xuMaxActual) / (0.87 * inputs.fy);
  const ast2 = (asc * fsc) / (0.87 * inputs.fy);
  const totalAst = ast1 + ast2; // Resulting in 499.44 for Mu=65
